...
Crafted with Next.js for a seamless user interface, Three.js for stunning 3D rendering, Framer Motion for captivating animations, and styled with TailwindCSS, this portfolio showcases the developer's skills in a distinctive and impactful way.
...
```bash
git clone https://github.com/MainaJoseph/Maina-JM-Portforlio-2.0.git
cd portfolio
```
